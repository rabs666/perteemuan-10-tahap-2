...
@section('content')
    <div style="background:#fff;padding:2rem;border-radius:8px;box-shadow:0 2px 8px rgba(0,0,0,0.06)">
        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:1.5rem">
            <h2 style="color:#2463d6;font-size:1.75rem;margin:0">Data Jenis Hewan</h2>
            ...
            <table style="width:100%;border-collapse:collapse;margin-top:1rem">
                <thead>
                    <tr style="background:#f8fafc;border-bottom:2px solid #e5e7eb">
                        ...
                        <th style="padding:1rem;text-align:left;font-weight:600;color:#1f2937">Nama Jenis Hewan</th>
                ...
                <tbody>
                    ...
                    <tr style="border-bottom:1px solid #e5e7eb;transition:background 0.2s" onmouseover="this.style.background='#f8fafc'" onmouseout="this.style.background='transparent'">
                        ...
                        <td style="padding:1rem;color:#374151;font-weight:500">{{ $jenis->idjenis_hewan }}</td>
                        <td style="padding:1rem;color:#374151">{{ $jenis->nama_jenis_hewan }}</td>
