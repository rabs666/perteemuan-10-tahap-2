            ...
            <table style="width:100%;border-collapse:collapse;margin-top:1rem">
                <thead>
                    <tr style="background:#f8fafc;border-bottom:2px solid #e5e7eb">
                        ...
                        <th style="padding:1rem;text-align:left;font-weight:600;color:#1f2937">Nama Role</th>
                ...
                <tbody>
                    ...
                    <tr style="border-bottom:1px solid #e5e7eb;transition:background 0.2s" onmouseover="this.style.background='#f8fafc'" onmouseout="this.style.background='transparent'">
                        ...
                        <td style="padding:1rem;color:#374151;font-weight:500">{{ $item->idrole }}</td>
                        <td style="padding:1rem;color:#374151">{{ $item->nama_role }}</td>
